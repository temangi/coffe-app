...
export const dictionary: Record<AppLanguage, Dict> = {
  ru: {
    ...
    delivery: {
      ...
      permissionDenied: 'Нет доступа к геолокации. Разрешите доступ в настройках приложения.',
      openSettings: 'Открыть настройки',
      locationServicesOff: 'Геолокация на устройстве выключена. Включите её в настройках.',
      locationError: 'Не удалось получить координаты. Попробуйте ещё раз или выберите точку на карте.',
    },
  ...
  kg: {
    ...
    common: { openMenu: 'Менюну ачуу', addToCart: 'Себетке кошуу', continueToPayment: 'Төлөмгө өтүү', setDeliveryAddress: 'Даректи көрсөтүү', placeOrder: 'Буйрутма берүү', back: 'Артка' },
    ...
    delivery: { title: 'Жеткирүү', subtitle: 'Буйрутмадан мурун даректи көрсөтүңүз', gps: 'Учурдагы геолокация', map: 'Картадан тандоо', manual: 'Даректи кол менен киргизүү', detect: 'Жайгашкан жерди аныктоо', detecting: 'Жайгашкан жер аныкталууда…', pointNotSelected: 'Чекит тандалган жок', confirm: 'Жеткирүү дарегин ырастоо', permissionDenied: 'Геолокацияга уруксат жок. Колдонмонун жөндөөлөрүнөн уруксат бериңиз.', openSettings: 'Жөндөөлөрдү ачуу', locationServicesOff: 'Түзмөктө геолокация өчүк. Аны күйгүзүңүз.', locationError: 'Координаттар алынган жок. Кайра аракет кылыңыз же картаны тандаңыз.' },
  ...
  en: {
    ...
    common: { openMenu: 'Open menu', addToCart: 'Add to cart', continueToPayment: 'Continue to payment', setDeliveryAddress: 'Set delivery address', placeOrder: 'Place order', back: 'Back' },
    ...
    delivery: { title: 'Delivery', subtitle: 'Select delivery point before checkout', gps: 'Current GPS location', map: 'Pick on map', manual: 'Enter address manually', detect: 'Detect location', detecting: 'Getting your location…', pointNotSelected: 'No point selected', confirm: 'Confirm delivery address', permissionDenied: 'Location access denied. Allow it in the app settings.', openSettings: 'Open settings', locationServicesOff: 'Location services are turned off on this device.', locationError: 'Could not get coordinates. Try again or pick a point on the map.' },
